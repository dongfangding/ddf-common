...
public class ExcelLocalTranslatorHelper {
    ...
    static {
        FILE_HEADER_MAP.put("messages.properties", "中文简体");
        FILE_HEADER_MAP.put("messages_ar.properties", "Arabic");
        FILE_HEADER_MAP.put("messages_bn.properties", "Bangala");
        FILE_HEADER_MAP.put("messages_en.properties", "English");
        FILE_HEADER_MAP.put("messages_es.properties", "Spanish");
        FILE_HEADER_MAP.put("messages_fil.properties", "Filipino");
        FILE_HEADER_MAP.put("messages_fr.properties", "French");
        FILE_HEADER_MAP.put("messages_hi.properties", "Hindi");
        FILE_HEADER_MAP.put("messages_id.properties", "Indonesian");
        FILE_HEADER_MAP.put("messages_ja.properties", "Japanese");
        FILE_HEADER_MAP.put("messages_ko.properties", "Korean");
        FILE_HEADER_MAP.put("messages_pt.properties", "Portuguese");
        FILE_HEADER_MAP.put("messages_vi.properties", "Viet Nam");
        FILE_HEADER_MAP.put("messages_zh-hans.properties", "中文简体");
        FILE_HEADER_MAP.put("messages_zh-hant.properties", "中文繁体");
        FILE_HEADER_MAP.put("messages_de.properties", "German");
        FILE_HEADER_MAP.put("messages_ru.properties", "Russian"); //俄语
        FILE_HEADER_MAP.put("messages_tr.properties", "Turkish"); //土耳其语
        FILE_HEADER_MAP.put("messages_am.properties", "Amharic"); //埃塞俄比亚语-阿姆哈拉语
    }

    // 输出目录：写入到 src/main/resources/i18n 目录下
    String OUTPUT_DIR = System.getProperty("user.dir") + "/wheel/wheel-mvc/src/main/resources/i18n/";
