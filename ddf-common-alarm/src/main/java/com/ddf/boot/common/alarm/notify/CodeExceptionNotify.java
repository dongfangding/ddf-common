...
public class CodeExceptionNotify implements ApplicationListener<GlobalExceptionEvent> {
    ...
    private void sendToDingTalk(GlobalExceptionEventPayload payload) {
        try {
            ...
            final DingTalkProperties.Properties codeExceptionProperties = dingTalkProperties.getCodeProperties(applicationName);
            ...
            sbl
                ...
                .append(" \n");
            DingTalkUtil.sendMarkdownMsgToAllWithLimit(
                codeExceptionProperties.getSecret(),
