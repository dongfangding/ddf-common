...
public class CodeExceptionNotify implements ApplicationListener<GlobalExceptionEvent> {
    ...
    private void sendToDingTalk(GlobalExceptionEventPayload payload) {
        try {
            ...
            final DingTalkProperties.Properties codeExceptionProperties = dingTalkProperties.getCodeProperties(
                    applicationName);
            ...
            DingTalkUtil.sendMarkdownMsgToAllWithLimit(codeExceptionProperties.getSecret(),
                    codeExceptionProperties.getAccessToken(), "代码异常告警", sbl.toString());
        } catch (Exception e) {
    ...
    private void sendToLark(GlobalExceptionEventPayload payload) {
        try {
            ...
            final List<List<LarkTag>> lists = List.of(List.of(LarkTag.buildText(
                    ...
                    List.of(LarkTag.buildText("异常详情: " + payload.getErrorMessage())),
                    List.of(LarkTag.buildAtAll()));
