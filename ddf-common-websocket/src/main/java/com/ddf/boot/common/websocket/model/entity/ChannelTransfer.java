...
public class ChannelTransfer extends BaseDomain {
    ...
    /** 服务端主动发送数据表示 */
    public static final Byte SEND_FLAG_SERVER = 0;
    /** 客户端主动发送数据标识 */
    public static final Byte SEND_FLAG_CLIENT = 1;
    ...
    /** 已响应 */
    public static final Byte STATUS_RESPONSE = 2;
    /** 已处理 */
