...
import com.ddf.common.ons.consumer.OnsMessageListener;
...
public class BaseOnsListenerContainer implements OnsListenerContainer {
    ...
    private OnsMessageListenerAno annotation;
    ...
    public String toString() {
        return "DefaultOnsListenerContainer{" + "name='" + name + '\'' + ", accessKey='" + accessKey + '\''
                + ", secretKey='***'" + ", nameServerAddr='" + nameServerAddr + '\'' + ", consumeMode=" + consumeMode
                + ", groupId='" + groupId + '\'' + ", topic='" + topic + '\'' + ", expressionType=" + expressionType
                + ", expression='" + expression + '\'' + ", messageModel=" + messageModel + ", consumeThreadNums="
                + consumeThreadNums + ", consumeTimeout=" + consumeTimeout + ", consumeMessageBatchMaxSize="
                + consumeMessageBatchMaxSize + ", running=" + running + '}';
    }
