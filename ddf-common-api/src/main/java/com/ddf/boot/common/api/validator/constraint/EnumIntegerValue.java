...
@Constraint(validatedBy = EnumIntegerValue.EnumIntegerValueValidator.class)
@Documented
public @interface EnumIntegerValue {
     ...
     *
     * @author snowball
     * @since 2025/11/17 11:47
     **/
    class EnumIntegerValueValidator implements ConstraintValidator<EnumIntegerValue, Integer> {

        private Class<? extends IEnum<?>> enumClass;
        private boolean required;

        @Override
        public void initialize(EnumIntegerValue constraintAnnotation) {
            // 获取注解中的枚举类型
