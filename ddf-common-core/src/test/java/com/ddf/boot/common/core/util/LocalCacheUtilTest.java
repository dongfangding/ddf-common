...
public class LocalCacheUtilTest {
    ...
    public void testGetGuavaCache() {
        LoadingCache<String, String> loadingCache = CacheBuilder.newBuilder().maximumSize(100).build(
                new CacheLoader<>() {
                    @Override
    ...
    public void testBuildCaffeineDefaultValue() {
        com.github.benmanes.caffeine.cache.LoadingCache<String, String> cache = LocalCacheUtil.buildCaffeine(10,
                Duration.ofMinutes(1), key -> null, "DEFAULT");
    ...
    public void testBatchLoadDefaultValueForMissingKey() {
        Map<String, String> result = LocalCacheUtil.batchLoad(java.util.Set.of("a", "b"),
                keys -> Map.of("a", "value-a"), "DEFAULT");
    ...
    public void testGetCaffeineCacheCheckDefaultOptionalValue() {
        com.github.benmanes.caffeine.cache.LoadingCache<String, Optional<String>> cache = LocalCacheUtil.buildCaffeine(
                10, Duration.ofMinutes(1), key -> Optional.empty(), Optional.empty());
    ...
    public void testGetCaffeineCacheCheckDefaultListValue() {
        com.github.benmanes.caffeine.cache.LoadingCache<String, Optional<String>> cache =
                LocalCacheUtil.buildBatchLoadCaffeine(10, Duration.ofMinutes(1),
                        keys -> Map.of("a", Optional.of("value-a"), "b", Optional.empty()), Optional.empty());
    ...
    public void testGuavaCacheRefreshAfterWrite() throws InterruptedException, ExecutionException {
        LoadingCache<String, String> loadingCache = CacheBuilder.newBuilder().maximumSize(100).refreshAfterWrite(100,
