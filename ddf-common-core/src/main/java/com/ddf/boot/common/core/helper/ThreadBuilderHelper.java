...
public class ThreadBuilderHelper {
            ...
            if (!PRINT_RUNNING_STATE_EXECUTOR.isEmpty()) {
                ...
                PRINT_RUNNING_STATE_EXECUTOR.forEach(executor -> {
                    ...
                    log.info(
                            ...
                            threadPoolExecutor.getQueue().size(), executor.getQueueCapacity(),
    ...
    public static ThreadPoolTaskExecutor buildThreadExecutor(String prefix, int keepAliveSeconds, int queueCapacity,
        ...
        return buildThreadExecutor(prefix, keepAliveSeconds, queueCapacity, getDefaultCorePoolSize(),
                getDefaultMaxPoolSize(), new ThreadPoolExecutor.CallerRunsPolicy(), gracefulShutdown, true);
    }
    ...
    public static ScheduledThreadPoolExecutor buildScheduledExecutorService(String prefix, int keepAliveSeconds) {
        return buildScheduledExecutorService(prefix, keepAliveSeconds, true,
    ...
    public static ScheduledThreadPoolExecutor buildScheduledExecutorService(String prefix, int keepAliveSeconds,
            boolean gracefulShutdown) {
        return buildScheduledExecutorService(prefix, keepAliveSeconds, gracefulShutdown,
                Runtime.getRuntime().availableProcessors() + 1, Runtime.getRuntime().availableProcessors() * 2);
    }
